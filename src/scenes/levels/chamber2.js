class Chamber2 extends Phaser.Scene {
    ...
    update() {
        ...
        if(keyDOWN.isDown&&this.screen == 1){
            this.player1.body.setVelocityY(this.MOVE_SPEED*1.5);
        ...
        if(keyLEFT.isDown&&this.screen == 1){
            this.player1.body.setVelocityX(-this.MOVE_SPEED*1.5);
...
createTooltip(){
    ...
    this.name = this.add.text(game.config.width/2, game.config.height/2-230, "Push & Pull 2", this.textConfig).setOrigin(0.5).setDepth(1);
