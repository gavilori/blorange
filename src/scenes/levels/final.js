...
createTooltip(){
    ...
    this.helpText1 = this.add.text(game.config.width/2, game.config.height/2-150, "Here are four final chambers to test your skills.", this.textConfig).setOrigin(0.5).setDepth(1);
